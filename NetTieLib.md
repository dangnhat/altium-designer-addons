...
![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViasPadClass.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViasPadClass.png)
...
![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/RULimport.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/RULimport.png)


# List of library components #
| Name | Symbol(s) | Footprint (MP version only) | Description | Note |
|:-----|:----------|:----------------------------|:------------|:-----|
| 2way | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2wayPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2wayPCB.png) | 2 way net tie junction | Typically used for joining two nets together, e.g. AGND and DGND |
| 3wayT | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayTSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayTSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayTPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayTPCB.png) | 3 way net tie junction T shape | Typically used for splitting signal to two receivers on board, e.g. clock signal to 2 ICs  |
| 3wayY | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayYSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayYSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayYPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/3wayYPCB.png) | 3 way net tie junction Y shape |      |
| 4way | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayCrossSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayCrossSch.png)![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayHSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayHSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/4wayPCB.png) | 4 way net tie junction | Schematic symbol has alternative graphics, see component Properties >> Display mode in schematic editor. |
| NetTieVia | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViaSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViaSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViaPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/NetTieViaPCB.png) | Net Tie Via | Connected signals are usually spread on different layers. Ignore Obsatacles routing mode should be used. |
| StarPoint | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/StarPointSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/StarPointSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/StarPointPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/StarPointPCB.png) | Star point for definition of starburst topology | Routing topology rule must be applied in PCB. The rule can be imported from GNDtopologyStar.RUL, see [Design Rule Check exceptions](NetTieLib#Design_Rule_Check_exceptions.md) section. |
| 2waySolderNC | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNCSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNCSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNCPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNCPCB.png) | 2 way net solder junction - Normally Connected | Soldered connection marked in silkscreen and by 3D body. |
| 2waySolderNO | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNOSch.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNOSch.png) | ![https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNOPCB.png](https://altium-designer-addons.googlecode.com/svn/trunk/Libs_NetTieLib/Documentation/wiki/2waySolderNOPCB.png) | 2 way net solder junction - Normally Open |      |
